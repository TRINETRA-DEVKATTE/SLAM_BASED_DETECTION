...
namespace Blink
{
	...
	public static class Program
	{
		...
		/// <summary>Front Sensor Pin</summary>
		public static readonly byte FrontSensorPin = Pins.GetPin(16, PinType.Physical, PinType.BCM);
		...
		public static void Main()
		{
			...
			while (true)
			{
				Foreward();Thread.Sleep(2000);
				Backward();Thread.Sleep(2000);
				Left();Thread.Sleep(2000);
				Right();Thread.Sleep(2000);
				Idle();Thread.Sleep(2000);
			}
		}
